...
namespace Validateur.Type.Nombre
{
    ...
    {/// <summary>
     ...
     /// <param name="nomParametre">Nom du paramètre.</param>
        public static void Entre(this long i, long valeurMaximum, decimal valeurMinimum, string nomParametre)
        {
        ...
        public static void Inferieur(this long i, long valeurMaximum, string nomParametre)
        {
            i.NonNull(nomParametre);
        ...
        /// </summary>
        /// <param name="nomParametre">Nom du paramètre.</param>
        public static void Positif(this long i, string nomParametre)
        {
            i.NonNull(nomParametre);
        ...
        /// </summary>
        /// <param name="nomParametre">Nom du paramètre.</param>
        public static void StrictementPositif(this long i, string nomParametre)
        {
            i.NonNull(nomParametre);
        ...
        /// <param name="valeurMinimum">Valeur minimum.</param>
        /// <param name="nomParametre">Nom du paramètre.</param>
        public static void Superieur(this long i, long valeurMinimum, string nomParametre)
        {
            i.NonNull(nomParametre);
